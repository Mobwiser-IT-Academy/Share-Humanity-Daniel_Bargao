...
const dll_countries = document.getElementById('select_countries');
generateCountyList();

function generateCountyList() {
  dll_countries.innerHTML = `<option value="" disabled selected>Select your Organization Country</option>`
  for (i = 0; i < countryList.length; i++) {
    dll_countries.innerHTML += `<option value="${i}">${countryList[i].country}</option>`
  }
}

const dll_cities = document.getElementById('select_cities');
generateCityList();
